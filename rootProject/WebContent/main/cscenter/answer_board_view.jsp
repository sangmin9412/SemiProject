	...
	<div id="wrap">
		...
		<main id="container">
			...
			<div class="board-view">
				<div class="head">
					<h3 class="tit">${ answerList.boardSubject }</h3>
					<div class="info">
						<span class="name"><strong>${ answerList.boardName }</strong></span>
						<span class="date">${ answerList.boardDate }</span>
						<span class="hit"><strong>조회수</strong> ${ answerList.readCount + 1 }</span>
					</div>
				</div>
				<div class="body">
					${fn:replace(answerList.boardContent,cn,br)}
					<br>
					<img src="/main/cscenter/answerupload/${ answerList.storeFileName }" alt="" />
				</div>
			</div>
			
			<div class="buttons">
				<div class="fr">
					<a href="answerModify.ab?boardNum=${ answerList.boardNum }" class="btn-pack medium">수정</a>
				</div>
			</div>
