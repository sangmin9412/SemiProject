					...
					<div class="panel panel-default">
					    <div class="panel-body" style="padding:100px 0;">
					    	...
					    	<div class="login-area">
					    		<form action="mainLogIn.pomain" name="" method="post" role="form">
					    			<div class="form-group">
	                                    <input type="text" class="form-control" name="partnerId" id="" value="" placeholder="ID">
	                                </div>
	                                <div class="form-group">
	                                    <input type="password" class="form-control" name="partnerPw" id="" value="" placeholder="Password">
	                                </div>
	                                <div class="form-group">
