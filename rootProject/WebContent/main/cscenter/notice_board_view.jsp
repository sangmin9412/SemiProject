...
<%@ include file = "/include/head.jsp" %>
	<div id="wrap">
		...
		<main id="container">
			<div class="sub-title">
				<div class="contain">
					<h2>공지사항 <span class="num">(${ count })</span></h2>
				</div>
			</div>
			...
			<div class="board-view">
				<div class="head">
					<h3 class="tit">${ noticeList.boardSubject }</h3>
					<div class="info">
						<!-- <span class="name"><strong>${ noticeList.boardName }</strong></span> -->
						<span class="date" style="margin-left: 0; padding-left: 0; border-left: 0;">${ noticeList.boardDate }</span>
						<span class="hit"><strong>조회수</strong> ${ noticeList.readCount + 1 }</span>
					</div>
				</div>
				<div class="body">${fn:replace(noticeList.boardContent,cn,br)}</div>
			</div>
